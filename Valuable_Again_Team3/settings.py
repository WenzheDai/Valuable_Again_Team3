"""
Django settings for Valuable_Again_Team3 project.
...
ALLOWED_HOSTS = ['valuable888again.pythonanywhere.com', 'localhost']
...
ROOT_URLCONF = 'Valuable_Again_Team3.urls'
...
WSGI_APPLICATION = 'Valuable_Again_Team3.wsgi.application'
